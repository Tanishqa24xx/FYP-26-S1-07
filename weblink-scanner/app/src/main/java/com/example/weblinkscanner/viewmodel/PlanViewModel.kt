// WeblinkScanner\app\src\main\java\com\example\weblinkscanner\viewmodel\PlanViewModel.kt
...
class PlanViewModel(private val repository: WeblinkScannerRepository) : ViewModel() {
    ...
    fun loadMyPlan() {
        viewModelScope.launch {
            ...
            when (val result = repository.getMyPlan()) {
